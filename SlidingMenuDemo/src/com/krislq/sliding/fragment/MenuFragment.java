...
public class MenuFragment extends PreferenceFragment implements OnPreferenceClickListener{
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        if("a".equals(key)) {
            ...
            .replace(R.id.content, contentFragment == null ?ContentFragment.newInstance("This is A Menu"):contentFragment ,"A")
            .commit();
            ...
            fragmentManager.beginTransaction()
            .replace(R.id.content, contentFragment == null ?ContentFragment.newInstance("This is B Menu"):contentFragment,"B")
            .commit();
            ...
            fragmentManager.beginTransaction()
            .replace(R.id.content, contentFragment == null ? ContentFragment.newInstance("This is C Menu"):contentFragment,"C")
            .commit();
        }
